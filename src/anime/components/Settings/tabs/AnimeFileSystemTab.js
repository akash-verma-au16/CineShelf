...
export default function AnimeFileSystemTab() {
	const { settings, showToast } = useAnime();
	const sourceDirs = settings?.animeSourceDirs || [];
		...
		<div className="px-8 py-8">
			<div className="mb-6">
				...
				<p className="text-sm text-gray-500 mt-1">
					Browse anime source directories. Hover any item and click the pencil
	...
	return (
		<div>
			<div
				...
				{/* Reload button for dirs on hover */}
				...
				{/* Rename button — hidden for root dirs */}
				{!isRenaming && !isRoot && (
					<button
						onClick={(e) => {
							e.stopPropagation();
